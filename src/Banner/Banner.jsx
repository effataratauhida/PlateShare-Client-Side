         ...
         <div  >
            ...
            <div  className=" relative mb-10 sm:mb-20">
             ...
             <div  className='max-w-11/12 mx-auto absolute inset-0 flex flex-col items-center justify-center text-center'>
                <h1 className=' text-[#edf8e9] text-3xl md:text-4xl font-bold  
                md:pt-0 md:mt-0'>PlateShare – Donate. Connect. Care.</h1>
                <p className=' text-[#edf8e9] mt-7 md:text-lg text-base
                font-medium'>Turn your leftovers into hope. PlateShare makes it easy to share food and make a difference in your community.</p>

                <Link 
                to="/availableFoods"
                className='mt-5 md:py-3 md:px-10 py-2 px-6
                cursor-pointer rounded-sm font-semibold md:text-lg text-base
            ...
            className='max-w-11/12 mx-auto pb-12 md:pb-20'>
            
                <h1 className=' text-[#005a32] text-3xl md:text-4xl font-bold 
                text-center'>
                    Most Available Meals</h1>
                <p className='text-[#005a32] mt-5 md:text-lg text-base font-medium text-center'>
                    Here are the food items with the largest servings. Pick your favorite and help reduce food waste together.</p>

                    {/* card layout */}
                <div className=' grid lg:grid-cols-3 grid-cols-1 sm:grid-cols-2 gap-5 pb-12 md:pb-20 mt-14'>
                    {topFoods.map(food => (
            ...
            <div data-aos="fade-up" className='max-w-11/12 mx-auto pb-20 '>
                ...
                <h1 className=' text-[#005a32] text-3xl md:text-4xl font-bold  text-center'>
                    How It Works</h1>
                <p className='text-[#005a32] mt-5 md:text-lg text-base font-medium text-center'>
           ...
           {/* steps */}
            <div className=' grid grid-cols-1 sm:grid-cols-3 gap-5 mt-10'>
                ...
                <h3 className=' font-bold text-lg sm:text-xl text-[#005a32] mt-2' >Post Food</h3>
              ...
              <div className='bg-[#edf8e9] p-4  rounded-sm shadow-lg'>
                ...
                <h3 className=' font-bold text-lg sm:text-xl text-[#005a32] mt-2' >Find Food</h3>
                <p className=' text-[#005a32] text-base mt-2 font-medium'>
              ...
              <div className='bg-[#edf8e9] p-4  rounded-sm shadow-lg'>
                ...
                <h3 className=' font-bold text-lg sm:text-xl text-[#005a32] mt-2' >Collect Food</h3>
                <p className=' text-[#005a32] text-base mt-2 font-medium'>
